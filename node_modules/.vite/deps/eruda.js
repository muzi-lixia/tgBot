        ...
        var __webpack_modules__ = { 3312: function(e, t, n) {
          ...
          var dt = function(e2) {
            ...
            return (0, s.A)(t2, e2), (0, r.A)(t2, [{ key: "show", value: function() {
              ...
              var s2 = e3.name;
              if (!s2) return Ke.error("You must specify a name for a tool");
              if (this._tools[s2]) return Ke.warn("Tool ".concat(s2, " already exists"));
              ...
              var t3 = this._tools;
              if (!t3[e3]) return Ke.warn("Tool ".concat(e3, " doesn't exist"));
              this._tab.remove(e3);
              var n2 = t3[e3];
              ...
              "System preference" === e3 && (e3 = tt()() ? "Dark" : "Light"), V(e3) ? t3.addClass(Ie("dark")) : t3.rmClass(Ie("dark")), re.setTheme(e3);
          ...
          var on = new (Vt())();
          on.register("Network", Kt), on.register("Overlay", Xt), on.register("DOM", nn(nn({}, Zt), {}, { getNodeId: Zt.getDOMNodeId, getNode: Zt.getDOMNode })), on.register("Storage", en);
          var rn = on, an = n(92), sn = n(4095), cn = n.n(sn), ln = n(3737), un = n.n(ln), dn = n(5004), fn = n.n(dn), hn = n(1849), pn = n.n(hn);
            ...
            function t2() {
              ...
              return (0, o.A)(this, t2), e3 = vn(this, t2), (0, c.A)(e3, "_reqWillBeSent", function(t3) {
                ...
                Rt()(function(e4) {
                  var t4 = fn()();
                  "windows" === t4 && (t4 = "win");
                  var n2 = [], o2 = pn()(["accept-encoding", "host", "method", "path", "scheme", "version"]), r2 = "win" === t4 ? function(e5) {
                    var t5 = /[\r\n]/.test(e5) ? '^"' : '"';
          ...
          var Jn = function() {
            return (0, r.A)(function e2(t2, n2) {
              ...
              if (s2 && 0 !== B()(s2).length && (t2.listeners = s2), eo(a2)) return t2;
          ...
          var Wn = function(e2) {
            return Ae()(e2, function(e3) {
              ...
              return t2 = Dt()(t2), ("src" === n2 || "href" === n2) && !ot()(t2, "data") && (t2 = to(t2)), "style" === n2 && (t2 = Xn(t2)), { name: n2, value: t2 };
            });
          }, Vn = /rgba?\((.*?)\)/g, Kn = /url\("?(.*?)"?\)/g;
          function Xn(e2) {
          ...
          var io = function(e2) {
            function t2() {
              ...
              return (0, o.A)(this, t2), e3 = oo(this, t2), (0, c.A)(e3, "_showDetail", function() {
                ...
                if (e3._curNode !== e3._htmlEl) {
                  for (var t3 = e3._curParentQueue, n2 = t3.shift(); !ao(n2); ) n2 = t3.shift();
                  e3.set(n2);
                }
              }), (0, c.A)(e3, "_updateScale", function(t3) {
                e3._splitMediaQuery.setQuery("screen and (min-width: ".concat(680 * t3, "px)"));
            ...
            return (0, s.A)(t2, e2), (0, r.A)(t2, [{ key: "init", value: function(e3, n2) {
              ...
              var e3 = function(e4) {
                var t4 = [], n2 = 0;
                for (; e4; ) t4.push({ text: Qn(e4, { noAttr: true }), idx: n2++ }), e4 = e4.parentElement;
                return t4.reverse();
              }(this._curNode), t3 = "";
          ...
          function vo(e2) {
            ...
            if (!window[t2]) {
              ...
              ot()(n2, "http") || (n2 = "http:"), uo()("".concat(n2, "//cdn.jsdelivr.net/npm/eruda-").concat(e2, "@").concat(mo[e2]), function(n3) {
                if (!n3 || !window[t2]) return Ke.error("Fail to load plugin " + e2);
            ...
            return (0, r.A)(function e2(t2, n2, r2, i2) {
              ...
              if (t2) {
                ...
                t2 = JSON.parse(JSON.stringify(t2)), x()(t2, function(t3, o2) {
                  E()(t3) && (e2.config.get("hideErudaSetting") && (ot()(o2, "eruda") || "active-eruda" === o2) || n2.push({ key: o2, val: Gt()(t3, 200) }));
                }), this._storeData = n2;
              }
            } }, { key: "_updateButtons", value: function() {
          ...
          var zo = function() {
            return (0, r.A)(function e2(t2, n2) {
              ...
              for (var t2 = rn.domain("Network").getCookies().cookies, n2 = 0, o2 = t2.length; n2 < o2; n2++) if (t2[n2].name === e2) return t2[n2].value;
              return "";
            } }, { key: "_bindEvent", value: function() {
              var e2 = this, t2 = this._devtools;
              function n2(e3, n3) {
          ...
          function Io(e2, t2) {
            ...
            if (!n2) {
              if (Array.isArray(e2) || (n2 = function(e3, t3) {
                if (e3) {
                  if ("string" == typeof e3) return Bo(e3, t3);
                  var n3 = {}.toString.call(e3).slice(8, -1);
                  return "Object" === n3 && e3.constructor && (n3 = e3.constructor.name), "Map" === n3 || "Set" === n3 ? Array.from(e3) : "Arguments" === n3 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3) ? Bo(e3, t3) : void 0;
                }
          ...
          var Ro = function(e2) {
            ...
            return (0, s.A)(t2, e2), (0, r.A)(t2, [{ key: "init", value: function(e3, n2) {
              ...
              t3 && t3.getEntries ? this._performance.getEntries().forEach(function(t4) {
                if ("img" === t4.initiatorType || Po(t4.name)) {
              ...
              function r2(e4) {
                return function(t4) {
                  if (n2.get("sources")) {
                    ...
                    "iframe" !== e4 && xo()(location.href, r3) ? Co()({ url: r3, success: function(t5) {
                      o2(e4, t5);
          ...
          var rr = function(e2) {
            ...
            if (this._checkInit()) return vt()(e2) && (e2 = e2(this)), this._devTools.add(e2), this;
          }, remove: function(e2) {
          ...
          t.clear = function() {
            ...
            if (!p2 || o2 || B(l2) || a2.push({ name: "__proto__", configurable: true, enumerable: false, isOwn: (0, A.default)(l2, "__proto__"), value: E(p2, { self: f2 }), writable: false }), t2) return { result: a2 };
            var M2 = [];
